    ...
    <div class="min-h-screen bg-gray-50 flex">
        <aside class="w-64 bg-white border-r border-gray-200 hidden lg:block">
            ...
            <nav class="px-4 space-y-1">
                ...
                <a href="/Historique" class="flex items-center space-x-3 text-gray-600 hover:bg-gray-50 p-3 rounded-xl transition">
                ...
                <div class="relative inline-flex items-center p-3 text-gray-600 hover:text-blue-600 transition-colors cursor-pointer group">
                    <i class="fa-solid fa-cart-shopping text-xl group-hover:scale-110 transition-transform duration-200"></i>
                    <span class="absolute top-1 right-1 inline-flex items-center justify-center px-2 py-1 text-[10px] font-bold leading-none text-white transform translate-x-1/2 -translate-y-1/2 bg-blue-600 rounded-full border-2 border-white">
                        3
                    </span>
                </div>
                <div class="pt-10">
